 ...
 * fraction of full scale (0..1). Taken from the mono signal entering the
 * DSP, before the crossover and the master volume, so the LED shows the
 * signal whatever the volume. Clears on read.
 */
